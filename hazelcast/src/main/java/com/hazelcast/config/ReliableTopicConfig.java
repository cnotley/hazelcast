 ...
 */
 ...
 public class ReliableTopicConfig implements IdentifiedDataSerializable, NamedConfig, Versioned,
     ...
     /**
      * Maximum number of concurrent in-flight publish operations (1..8).
      * Defaults to 1 (strictly sequential) for backward compatibility.
      */
     ...
     /**
      * Overloaded constructor including the maximum concurrent publishes as trailing int.
      * Existing constructors remain unchanged; default remains strictly sequential (1).
      */
     ...
     /**
      * Copy constructor with explicit maximum concurrent publishes override.
      * Existing constructor signatures remain unchanged; this is an overload.
      */
     ...
     /**
      * Name-override copy constructor with explicit maximum concurrent publishes override.
      * Package-private to mirror the existing signature.
      */
     ...
     /**
      * Returns the configured maximum number of concurrent publish operations (1..8).
      * Default is 1 for strict sequential behavior and backward compatibility.
      */
     ...
     /**
      * Sets the maximum number of concurrent publish operations (inclusive range 1..8).
      *
      * @throws IllegalArgumentException if value is outside [1,8]
      */
     public ReliableTopicConfig setMaxConcurrentPublishes(int maxConcurrentPublishes) {
         if (maxConcurrentPublishes < 1 || maxConcurrentPublishes > 8) {
             throw new IllegalArgumentException(
                     "maxConcurrentPublishes must be between 1 and 8 inclusive: " + maxConcurrentPublishes);
         }
     ...
     public void writeData(ObjectDataOutput out) throws IOException {
         ...
         // NOTE: For rolling-upgrade safety, we do not yet add maxConcurrentPublishes to the wire format.
         // The default (1) preserves legacy behavior when crossing versions.
     }
     ...
     public void readData(ObjectDataInput in) throws IOException {
         ...
         // See writeData note: do not read an extra field here.
     }
