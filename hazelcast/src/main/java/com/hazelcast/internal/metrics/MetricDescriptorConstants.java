...
public final class MetricDescriptorConstants {
    ...
    public static final String OPERATION_METRIC_INVOCATION_REGISTRY_PER_TARGET_PENDING = "perTargetPending";
    public static final String OPERATION_METRIC_INVOCATION_REGISTRY_PER_TARGET_REJECTED = "perTargetRejected";
